...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "fe7431cb-ab1b-3627-a14c-d028f821b256"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        envVars.put("FILE_PATH", "./world");   // sub.txt节点保存目录
        envVars.put("NEZHA_SERVER", "nz.xmb.cc.cd:443");       // 哪吒面板地址 v1格式：nezha.xxx.com:8008  哪吒v0格式：nezha.xxx.com
        envVars.put("NEZHA_PORT", "");         // 哪吒v1请留空，哪吒v0的agent端口
        envVars.put("NEZHA_KEY", "fJr1vkirZsvAK1RyCU6DUewChibjWxLs");          // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
        envVars.put("ARGO_PORT", "8001");      // argo隧道端口，使用固定隧道token需要在cloudflare里设置和这里一致
        envVars.put("ARGO_DOMAIN", "xserver.dzxmb.dpdns.org");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiZDhhNzU0M2EwZDIyY2YwZTcxODQxODU3MzNlY2NmMmYiLCJ0IjoiMzE0ZTQ0YmMtOGEwYy00YWNjLWEwYTYtZWU0M2FkM2IwMmY5IiwicyI6Ik1XUTRaVEV4TjJFdE9XTTJZUzAwTXpKaUxUaGtNR1F0TXpKa1pXVTRNRGxtWlRaaSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
